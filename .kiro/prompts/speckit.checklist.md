...
3. **Clarify intent (dynamic)**: Derive up to THREE initial contextual clarifying questions (no pre-baked catalog). They MUST:
   ...
   - Be skipped individually if already unambiguous in `(the user will provide the argument in this conversation)`
...
4. **Understand user request**: Combine `(the user will provide the argument in this conversation)` + clarifying answers:
